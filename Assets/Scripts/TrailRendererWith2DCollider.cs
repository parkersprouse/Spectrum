...
public class TrailRendererWith2DCollider : MonoBehaviour {
    ...
    //[HideInInspector] public Vector2[] colliderPath;
    ...
    private void Awake() {
        ...
        GameObject trail = new GameObject(trailName, new[] { typeof(MeshRenderer), typeof(MeshFilter), typeof(EdgeCollider2D) });
        ...
        collider = trail.GetComponent<EdgeCollider2D>();
